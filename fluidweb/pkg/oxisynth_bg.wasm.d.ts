...
export const oxisynth_control_change: (a: number, b: number, c: number, d: number) => void;
export const oxisynth_pitch_bend: (a: number, b: number, c: number) => void;
export const oxisynth_all_notes_off: (a: number, b: number) => void;
export const oxisynth_all_sound_off: (a: number, b: number) => void;
export const __wbg_outputdevice_free: (a: number, b: number) => void;
export const outputdevice_close: (a: number) => void;
export const wasm_bindgen__convert__closures_____invoke__h68190eb64e7e6295: (a: number, b: number) => void;
export const wasm_bindgen__closure__destroy__h1176e573b102decf: (a: number, b: number) => void;
